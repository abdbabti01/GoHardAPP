...
import 'package:go_hard_app/data/services/session_request_context.dart' as _i11;
...
class MockApiService extends _i1.Mock implements _i9.ApiService {
  ...
  set beforeDispatchEpochCheckForTesting(
    _i3.Future<void> Function()? _beforeDispatchEpochCheckForTesting,
  ) => super.noSuchMethod(
    Invocation.setter(
  ...
  @override
  set testHttpClientAdapter(_i10.HttpClientAdapter? adapter) =>
      super.noSuchMethod(
  ...
  _i3.Future<T> get<T>(
    ...
    _i11.SessionRequestContext? sessionContext,
  }) =>
      (super.noSuchMethod(
            Invocation.method(
              #get,
...
class MockLocalDatabaseService extends _i1.Mock
    implements _i13.LocalDatabaseService {
