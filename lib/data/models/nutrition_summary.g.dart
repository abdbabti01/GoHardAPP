...
NutritionProgress _$NutritionProgressFromJson(Map<String, dynamic> json) =>
    NutritionProgress(
      ...
      remaining: NutritionTotals.fromJson(
...
MacroBreakdown _$MacroBreakdownFromJson(
  Map<String, dynamic> json,
) => MacroBreakdown(
  ...
  averageDailyCalories: (json['averageDailyCalories'] as num?)?.toDouble() ?? 0,
  averageDailyProtein: (json['averageDailyProtein'] as num?)?.toDouble() ?? 0,
